...
<p><label><input type="checkbox" name="hasp_expire_enable" id="hasp_expire_enable" <?php if( $hasp_expire_enable == 1 ) echo 'checked="checked"'; ?>><?php _e( 'Datetime of expiration', 'hasp' ) ?></label></p>
